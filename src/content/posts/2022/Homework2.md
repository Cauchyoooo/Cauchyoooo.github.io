...
* 将优先对象组成树形结构，每个节点都是游戏对象（或数）。
    ...
    * 使用 BroadcastMessage() 方法，向子对象发送消息。写出 BroadcastMessage() 的伪代码。
        ...
        ![](../images/2022/Homework2/10.jpg)
        ![](../images/2022/Homework2/11.jpg)
        ![](../images/2022/Homework2/12.jpg)
